...
/* 교육 일정(schedule.js) "일 단위" 보기에서 날짜를 빨간색으로 표기하기 위한 한국 공휴일 목록(고정값, 음력 기준 공휴일 포함)
   설날/추석/부처님오신날 등은 매년 날짜가 바뀌므로, 매년 말 다음 해 목록을 확인/보완해주세요. */
var KR_HOLIDAYS=[
  ...
  '2025-05-05','2025-05-06','2025-06-06','2025-08-15','2025-10-03','2025-10-05','2025-10-06','2025-10-07','2025-10-08','2025-10-09','2025-12-25',
  ...
  '2027-01-01','2027-02-06','2027-02-07','2027-02-08','2027-03-01','2027-05-05','2027-06-06',
  '2027-08-15','2027-09-14','2027-09-15','2027-09-16','2027-10-03','2027-10-09','2027-12-25'
];
var VISIT_STATUS=[
...
/* evalPass/evalEvaluator/evalRetry: 하단 "Level별 평가 기준" 표에 그대로 반영되는 필드 —
   교육 과정 관리 탭에서 Level 편집으로 수정하면 평가 기준 표도 함께 갱신된다(EVAL_CRITERIA는 구버전 캐시 데이터용 대체값) */
var DEF_LEVELS=[
  {id:'lv0',level:0,title:'설비 기초 이해',
   ...
   evalPass:'80% 이상 정답',evalEvaluator:'교육 담당자',evalRetry:'당일 재교육 후 즉시 재시험 (1회 무료 재시험)',
   duration:'1~2일'},
  {id:'lv1',level:1,title:'기본 기능 조작 (Basic Operator)',
   ...
   evalPass:'체크리스트 전 항목 Pass',evalEvaluator:'교육 담당자',evalRetry:'미흡 항목만 보충실습 후 익일 재평가 (1회 허용)',
   duration:'3~5일'},
  {id:'lv2',level:2,title:'독립 운영 및 기본 유지보수 (Field Engineer)',
   ...
   evalPass:'고장 시나리오 전부 해결 · 관찰 2회 모두 통과',evalEvaluator:'교육 담당자 + 팀장',evalRetry:'미흡 영역 추가 OJT(1~2일) 후 재평가, 팀장 확인 필요',
   duration:'2~3주'},
  {id:'lv3',level:3,title:'전문 엔지니어 / 트레이너 (Technical Advanced Engineer)',
   ...
   evalPass:'평가자+심사위원 과반 이상 승인 · Follow-Up 결과 이상無',evalEvaluator:'교육 담당자 + 파트장 + 그룹장 + 심사위원',evalRetry:'보완 요구사항 이행 후 재심사, 또는 차기 방문 시 재도전',
...
var DEF_MODULES=[
  ...
  {id:'md_f',code:'F',name:'Handler Teaching',detail:'각 Module 축의 이동 위치 Position Teaching 방법 교육',level:2,method:'이론+실습',hours:8,resources:'교육 자료, 본사 설비'},
