    ...
    +'<div class="home-grid">'
      ...
      +'<div class="home-card"><div class="home-card-title">빠른 작업</div>'
        +'<div style="display:flex;gap:8px;margin-bottom:6px">'
          +'<div class="home-quick-btn" style="flex:1;margin-bottom:0" onclick="openApplyLinkInfo()">🔗 신청서 링크 복사</div>'
          +'<div class="home-quick-btn" style="flex:1;margin-bottom:0" onclick="previewApplyForm()">👀 신청서 미리보기</div>'
        +'</div>'
