...
ko:{
  ...
  sec1:'1. 신청 정보',
  applyDate:'신청일자',orgType:'소속 유형',orgTypePh:'예: 해외지사, Agent, 고객사, 자사 신입사원 등',org:'소속명',
  applicantName:'신청자(작성자)',applicantPosition:'직책/직급',applicantContact:'연락처',applicantEmail:'신청자 이메일',
  country:'국가',
  sec2:'2. 교육 대상자 정보',
  samePersonLbl:'신청자와 교육 대상자가 동일합니다 (아래 정보 자동 입력)',
  ...
  priorLevelNone:'-',
  traineeContact:'연락처',traineeEmail:'교육 대상자 이메일',
  sec3:'3. 교육 일정 및 희망 Level',
  equipment:'교육 희망 설비',
  desiredLevel:'희망 Level',desiredStart:'교육 희망 시작일',desiredEnd:'교육 희망 종료일',
  totalDays:'총 교육일수',
  sec4:'4. 사전 역량 자가진단',
  ...
  sec6:'5. 특이사항 및 요청사항',sec6ph:'언어 · 비자 · 숙소 · 안전/알레르기 등',
  sec7:'6. 신청자 확인',branchApprover:'신청자 서명',submitDate:'제출일자',
  ...
  reqOrg:'소속명',reqApplicant:'신청자(작성자)',reqContact:'연락처',reqTrainee:'대상자 성명',reqEmail:'교육 대상자 이메일',emailInvalid:'이(가) 올바른 이메일 형식이 아닙니다.',reqStart:'교육 희망 시작일',reqEnd:'교육 희망 종료일',reqEquipment:'교육 희망 설비를 1개 이상 선택해주세요.',
...
en:{
  ...
  formTitle:'Training Application Form',
  formSub:'BU2 FCBGA Substrate Inspection Equipment Level 0~3 Training',
  sec1:'1. Application Info',
  applyDate:'Application Date',orgType:'Organization Type',orgTypePh:'e.g. Overseas Branch, Agent, Customer, New Employee',org:'Organization Name',
  applicantName:'Applicant (Writer)',applicantPosition:'Position/Title',applicantContact:'Contact (Phone)',applicantEmail:'Applicant Email',
  country:'Country',
  sec2:'2. Trainee Info',
  samePersonLbl:'The applicant and the trainee are the same person (auto-fill below)',
  ...
  priorLevelNone:'-',
  traineeContact:'Contact (Phone)',traineeEmail:'Trainee Email',
  sec3:'3. Training Schedule & Desired Level',
  equipment:'Equipment',
  desiredLevel:'Desired Level',desiredStart:'Desired Training Start Date',desiredEnd:'Desired Training End Date',
  ...
  sec6:'5. Special Notes & Requests',sec6ph:'Language, visa, accommodation, safety/allergies, etc.',
  sec7:'6. Applicant Confirmation',branchApprover:'Applicant Signature',submitDate:'Submission Date',
  ...
  reqOrg:'Organization name',reqApplicant:'Applicant (Writer)',reqContact:'Contact',reqTrainee:'Trainee name',reqEmail:'Trainee email',emailInvalid:' is not a valid email address.',reqStart:'Desired training start date',reqEnd:'Desired training end date',reqEquipment:'Please select at least one equipment.',
...
'zh-CN':{
  ...
  sec1:'1. 申请信息',
  applyDate:'申请日期',orgType:'所属类型',orgTypePh:'例：海外分公司、Agent、客户、新员工等',org:'所属名称',
  applicantName:'申请人(填写人)',applicantPosition:'职务/职级',applicantContact:'联系方式(电话)',applicantEmail:'申请人邮箱',
  country:'国家',
  sec2:'2. 培训对象信息',
  samePersonLbl:'申请人与培训对象为同一人（自动填写以下信息）',
  ...
  priorLevelNone:'-',
  traineeContact:'联系方式(电话)',traineeEmail:'培训对象邮箱',
  sec3:'3. 培训日程及期望Level',
  equipment:'培训设备',
  desiredLevel:'期望Level',desiredStart:'期望培训开始日',desiredEnd:'期望培训结束日',
  totalDays:'总培训天数',
  sec4:'4. 事先能力自我评估',
  ...
  sec6:'5. 特殊事项及请求事项',sec6ph:'语言 · 签证 · 住宿 · 安全/过敏等',
  sec7:'6. 申请人确认',branchApprover:'申请人签名',submitDate:'提交日期',
  ...
  reqOrg:'所属名称',reqApplicant:'申请人(填写人)',reqContact:'联系方式',reqTrainee:'培训对象姓名',reqEmail:'培训对象邮箱',emailInvalid:'不是有效的邮箱格式。',reqStart:'期望培训开始日',reqEnd:'期望培训结束日',reqEquipment:'请至少选择一个培训设备。',
...
'zh-TW':{
  ...
  sec1:'1. 申請資訊',
  applyDate:'申請日期',orgType:'所屬類型',orgTypePh:'例：海外分公司、Agent、客戶、新進員工等',org:'所屬名稱',
  applicantName:'申請人(填寫人)',applicantPosition:'職務/職級',applicantContact:'聯絡方式(電話)',applicantEmail:'申請人郵箱',
  country:'國家',
  sec2:'2. 教育對象資訊',
  samePersonLbl:'申請人與教育對象為同一人（自動填寫以下資訊）',
  ...
  priorLevelNone:'-',
  traineeContact:'聯絡方式(電話)',traineeEmail:'教育對象郵箱',
  sec3:'3. 教育日程及期望Level',
  equipment:'教育設備',
  desiredLevel:'期望Level',desiredStart:'期望教育開始日',desiredEnd:'期望教育結束日',
  totalDays:'總教育天數',
  sec4:'4. 事前能力自我評估',
  ...
  sec6:'5. 特殊事項及請求事項',sec6ph:'語言 · 簽證 · 住宿 · 安全/過敏等',
  sec7:'6. 申請人確認',branchApprover:'申請人簽名',submitDate:'提交日期',
  ...
  reqOrg:'所屬名稱',reqApplicant:'申請人(填寫人)',reqContact:'聯絡方式',reqTrainee:'教育對象姓名',reqEmail:'教育對象郵箱',emailInvalid:'不是有效的電子郵件格式。',reqStart:'期望教育開始日',reqEnd:'期望教育結束日',reqEquipment:'請至少選擇一個教育設備。',
...
ja:{
  ...
  sec1:'1. 申込情報',
  applyDate:'申込日',orgType:'所属区分',orgTypePh:'例：海外支社、Agent、顧客、新入社員 等',org:'所属名',
  applicantName:'申込者(作成者)',applicantPosition:'役職',applicantContact:'連絡先(電話)',applicantEmail:'申込者メールアドレス',
  country:'国',
  sec2:'2. 教育対象者情報',
  samePersonLbl:'申込者と教育対象者は同一人物です（以下を自動入力）',
  traineeName:'氏名',traineePosition:'役職',traineeTask:'担当業務',
  visitCategory:'訪問区分',priorLevel:'再訪問時の以前修了Level',experienceYears:'現業務経歴(年)',
  priorLevelNone:'-',
  traineeContact:'連絡先(電話)',traineeEmail:'対象者メールアドレス',
  sec3:'3. 教育スケジュール及び希望Level',
  equipment:'教育設備',
  desiredLevel:'希望Level',desiredStart:'教育希望開始日',desiredEnd:'教育希望終了日',
  totalDays:'総教育日数',
  sec4:'4. 事前力量自己診断',
  ...
  sec6:'5. 特記事項及び要請事項',sec6ph:'言語 · ビザ · 宿泊 · 安全/アレルギー等',
  sec7:'6. 申込者確認',branchApprover:'申込者署名',submitDate:'提出日',
  ...
  reqOrg:'所属名',reqApplicant:'申込者(作成者)',reqContact:'連絡先',reqTrainee:'対象者氏名',reqEmail:'対象者メールアドレス',emailInvalid:'有効なメールアドレス形式ではありません。',reqStart:'教育希望開始日',reqEnd:'教育希望終了日',reqEquipment:'教育を受ける設備を1つ以上選択してください。',
...
vi:{
  ...
  sec6:'5. Ghi chú đặc biệt & Yêu cầu',sec6ph:'Ngôn ngữ · Visa · Chỗ ở · An toàn/Dị ứng, v.v.',
  sec7:'6. Xác nhận của người đăng ký',branchApprover:'Chữ ký người đăng ký',submitDate:'Ngày nộp',
